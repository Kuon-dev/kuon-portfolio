...
<section class="pt-2 navbar fixed w-full divCenter">
    <div class="2xl:flex flex-row py-3 px-3 hidden">
        ...
        <div class="text-2xl inline-block px-10 pt-[0.4rem]">
            <ul class="flex flex-row">
                <li class="px-3">
                    <button>
                        <router-link to="/contact" @click="Scroll_Top">Contact</router-link>
                    </button>
                </li>
                <li class="px-3">
                    <button>
        ...
        <div class="rightSide has-dpdn">
            ...
            <button class="border-2 rounded-lg p-[0.35rem] svg_border">
                <img src="../assets/theme.svg" class="svgColor inline" width="30px" height="30px"/>
            </button>
            <!-- drop down section  -->
            <ul class="p-3 px-5 mt-3 rounded-md dpdn translate-x-[-30%] drop-shadow-lg">
                <li class="py-1">
                ...
                <li class="py-1">
                    <button class="dpdn_item text-xl" id="dark_solar">Dark Solarized</button>
                </li>
                <li class="py-1">
    ...
    <!-- mobile viewport -->
    <div class="2xl:hidden flex flex-row py-3 px-3 items-center">
        <div>
            <h1 class="text-4xl font-bold sm:-ml-[0px]">
                <router-link to="/" @click="Scroll_Top" class="scroll-smooth">Aaron</router-link>
            </h1>
        </div>
        <div>
        ...
        <div class="rightSide flex flex-row">
            <div class="has-dpdn px-10">
            <!-- select theme icon -->
            <button class="border-2 rounded-md p-[0.35rem] svg_border">
                <img src="../assets/theme.svg" class="svgColor inline min-w-[30px] min-h-[30px]" width="30px" height="30px"/>
            </button>
            <!-- drop down section  -->
            <ul class="p-3 px-5 mt-3 rounded-md dpdn 2xl:translate-x-[-40%] lg:translate-x-[-30%] translate-x-[-35%] drop-shadow-lg whitespace-nowrap acrlyic">
                <li class="py-1 z-40">
                    <button class="dpdn_item md:text-2xl text-3xl" id="MB_light">Light</button>
                </li>
                <li class="py-1">
                    <button class="dpdn_item md:text-2xl text-3xl" id="MB_dark">Dark</button>
                </li>
                <li class="py-1">
                    <button class="dpdn_item md:text-2xl text-3xl" id="MB_solarized">Solarized</button>
                </li>
                <li class="py-1">
                    <button class="dpdn_item md:text-2xl text-3xl" id="MB_dark_solar">Dark Solarized</button>
                </li>
                <li class="py-1">
                    <button class="dpdn_item md:text-2xl text-3xl" id="MB_starfall">Starfall</button>
                </li>
            </ul>
        </div>
        <div class="has-dpdn ">
            <button class="">
                <div class="border-2 rounded-md p-[0.48rem] svg_border -mt-[1px]">
                    <div class="h-[0.2rem] w-[1.7rem] navbar_burger"></div>
                    <div class="h-[0.2rem] w-[1.7rem] navbar_burger mt-2"></div>
                    <div class="h-[0.2rem] w-[1.7rem] navbar_burger mt-2"></div>
                </div>
            </button>
            <ul class="p-3 px-5 mt-2 rounded-md dpdn xl:translate-x-[-10%] translate-x-[-60%] drop-shadow-lg whitespace-nowrap ">
                <li class="py-1">
